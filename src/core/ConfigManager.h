...
public:
    ...
    QString pveLanHost() const;
    QString effectivePveHost() const;
    int pvePort() const;
    ...
    void setPveLanHost(const QString &host);
    ...
    QString autoConnectProtocol() const;
    QString loginWelcomeText() const;
    QString footerBrandText() const;

    void setLanguage(const QString &lang);
    void setTheme(const QString &theme);
    void setKioskMode(bool enabled);
    void setAutoLogin(bool enabled);
    void setAutoConnect(bool enabled, const QString &connectionId = QString(), const QString &protocol = QString());
    void setLoginWelcomeText(const QString &text);
    void setFooterBrandText(const QString &text);
    ...
    // EasyTier P2P 设置
    bool useEasyTier() const;
    QString easyTierBinaryPath() const;
    bool enableTieredMode() const;
    QString easyTierNetworkName() const;
    QString easyTierNetworkSecret() const;
    QString easyTierServerPeerIp() const;
    QString easyTierBootstrapUrl() const;
    QString easyTierExtraArgs() const;

    void setUseEasyTier(bool enabled);
    void setEasyTierBinaryPath(const QString &path);
    void setEnableTieredMode(bool enabled);
    void setEasyTierNetworkName(const QString &name);
    void setEasyTierNetworkSecret(const QString &secret);
    void setEasyTierServerPeerIp(const QString &ip);
    void setEasyTierBootstrapUrl(const QString &url);
    void setEasyTierExtraArgs(const QString &args);
...
private:
    ...
    QString m_autoConnectProtocol = "RDP";
    QString m_loginWelcomeText = "欢迎使用云桌面";
    QString m_footerBrandText = "PVE Thin Client";
    ...
    // EasyTier P2P 设置
    bool m_useEasyTier = false;
    QString m_easyTierBinaryPath;
    bool m_enableTieredMode = false;
    QString m_easyTierNetworkName = "pve-easytier";
    QString m_easyTierNetworkSecret = "pve-easytier-secret";
    QString m_easyTierServerPeerIp;
    QString m_easyTierBootstrapUrl;
    QString m_easyTierExtraArgs;
};
