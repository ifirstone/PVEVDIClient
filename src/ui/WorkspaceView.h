...
private:
    ...
    void updateEasyTierIndicator(EasyTierState state);
    void refreshFooterBrandText();
    ...
    QLabel      *m_lblEasyTierDot;
    QLabel      *m_lblEasyTier;
    QTimer      *m_timer;
    QString     m_easyTierLinkMode;
    QString     m_pendingAutoConnectKey;
    bool        m_autoConnectTriggered = false;
};
