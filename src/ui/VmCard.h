...
private slots:
    ...
    void onPermissionsReceived(const QString &path, const QStringList &permissions);
...
private:
    ...
    void syncAutoStartupState();
    void updateAutoStartupHint();
    ...
    bool    m_autoStartupFlow = false;
    int     m_autoStartupRetry = 0;

    // 权限检查
    bool    m_hasSnapshotPermission = false;
    ...
    QLabel      *m_lblAutoStartupHint = nullptr;
    QCheckBox   *m_chkAutoStartup = nullptr;
